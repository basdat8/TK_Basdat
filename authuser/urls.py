...
from . views import (
    show_login, logout_view, pilih_role_view, form_pengguna_view, 
    form_dokterhewan_view, form_staff_view, dashboard_pengunjung,
    dashboard_dokter_hewan, dashboard_penjaga_hewan, dashboard_pelatih_hewan,
    dashboard_staf_admin, home_view, edit_profile_view, ubah_password_view
)
...
urlpatterns = [
    ...
    path('ubah-password/', ubah_password_view, name='ubah_password'),
